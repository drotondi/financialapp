...
5. Usa los botones "Generar PDF", "Exportar CSV", "Importar CSV" y "Borrar datos" para obtener un reporte imprimible, respaldar o recuperar datos precargados y limpiar tu información local.
